...
export function LearningPathCard({ icon, title, description, href }: LearningPathCardProps) {
  return (
    <Link
      href={href}
      className="bg-gradient-to-br from-navy to-[#1a2d4a] text-white p-xl rounded-[2px] flex flex-col justify-between min-h-[240px] select-none transition-all duration-300 hover:-translate-y-1 hover:shadow-brand-lg max-md:min-h-[220px] max-md:p-lg"
    >
      <div>
